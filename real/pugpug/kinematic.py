import numpy as np
from math import *
from config import KinematicParams

class Kinematic:
    def __init__(self, cfg):
        params = KinematicParams()
        self.L = params.body_length
        self.W = params.body_width
        self.l1 = params.leg_length_1
        self.l2 = params.leg_length_2
        self.l3 = params.leg_length_3
